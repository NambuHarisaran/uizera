...
export default function ParticipantLiveQuizPage({
  ...
  const handleSelect = async (questionId: string, optionIdx: number) => {
    ...
    try {
      ...
      toast.success(
        data.isCorrect ? `Locked in! +${data.pointsEarned} pts` : "Locked in!"
      );
    } catch (err) {
        ...
        {isEnded ? (
          ...
          >
            <Card className="border-t-4 border-t-amber-500 bg-card p-8 text-center shadow-xl">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                ...
                <span className="font-bold text-foreground">{myScore} pts</span>
              </p>
                ...
                {leaderboard.length === 0 ? (
                  ...
                  leaderboard.map((item, idx) => (
                    ...
                    >
                      ...
                      <span className="shrink-0 font-mono text-base font-extrabold text-amber-500">
                        {item.score} pts
                      </span>
                    </div>
                  ))
          ...
          >
            ...
            <p className="text-center text-xs text-muted-foreground">
              Your live score: <span className="font-bold text-foreground">{myScore} pts</span>
            </p>
          </motion.div>
        )}
      </AnimatePresence>
