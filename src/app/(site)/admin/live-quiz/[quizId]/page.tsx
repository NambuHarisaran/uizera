...
export default function AdminLiveQuizStagePage({
  ...
  return (
    ...
    >
          ...
          <div className="grid gap-6 lg:grid-cols-12 items-stretch">
            ...
            <Card className="lg:col-span-7 border bg-card/60 backdrop-blur-md p-6 flex flex-col justify-between shadow-sm min-h-[420px]">
              ...
              <p className="text-[11px] text-muted-foreground mt-4 pt-3 border-t flex items-center justify-between">
                ...
                <span className="font-mono font-semibold">UiZera Stage v2</span>
              </p>
            </Card>
          </div>
        </motion.div>
      ...
      {/* ── 2. ACTIVE QUESTION STAGE (NO ANSWER LEAK, Mentimeter Bars, Full Controls) ── */}
        ...
        <div className="space-y-6">
                ...
                <>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    {currentQ.options?.map((opt: string, oIdx: number) => {
                      ...
                      // CRITICAL FIX: Only show correct highlight/badge when isRevealed is TRUE!
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border bg-card p-4 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              {/* Next Question or Final Leaderboard */}
                ...
                <>
                  ...
                  {currentQIndex < questions.length - 1 ? (
                    ...
                    <Button
                      ...
                      className="gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold"
                    >
                      <Trophy className="h-4 w-4" /> Finalize Scores
                    </Button>
                  )}
                </>
              )}
      ...
      {!isFullscreen && (
        <div className="flex items-center justify-center gap-4 text-xs text-muted-foreground pt-4">
          ...
          <span className="flex items-center gap-1.5">
            <kbd className="px-1.5 py-0.5 rounded border bg-muted font-mono font-bold">→</kbd> Next Question
          </span>
          <span className="flex items-center gap-1.5">
